...
unwrapExports(index_browser_umd);
var index_browser_umd_1 = index_browser_umd.CounterImmutable;
...
var index_browser_umd$2 = createCommonjsModule(function (module, exports) {
(function (global, factory) {
	module.exports = factory();
}(commonjsGlobal, (function () { function unwrapExports$$1 (x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}
...
var Reference = unwrapExports(index_browser_umd$2);

function _tag2(tagKeys, tagSuffix, tagCounter, tagMap, changed, object) {
  tagKeys.forEach(function (key) {
    if (object.hasOwnProperty(key) && (_typeof(object[key]) === 'object' || object[key] === undefined)) {
      var objectTagged = object[key];
      var tagAndCount = tagMap.get(objectTagged);
      var _tag = void 0;
      if (tagAndCount) {
        _tag = tagAndCount[0];
        tagMap.set(objectTagged, [_tag, tagAndCount[1] + 1]);
      } else {
        _tag = tagCounter.allocate();
        tagMap.set(objectTagged, [_tag, 1]);
      }
      object[key + tagSuffix] = _tag;
      changed.set(true);
    }
  });
}
...
var TaggerImmutable = function () {
  function TaggerImmutable(tagKeys, tagSuffix) {
    ...
    var tagMap = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : immutable_1();

    _classCallCheck(this, TaggerImmutable);
  ...
  _createClass(TaggerImmutable, [{
    key: 'tag',
    value: function tag(object) {
      var _this = this;

      var changed = new Reference(false);
      var tagCounter = void 0,
          tagMap = void 0;
      tagCounter = this._tagCounter.transaction(function (counter) {
        tagMap = _this._tagMap.withMutations(function (map) {
          _tag2(_this._tagKeys, _this._tagSuffix, counter, map, changed, object);
        });
      });
      if (changed.get()) {
    ...
    value: function untag(object) {
      ...
      var tagCounter = void 0,
          tagMap = void 0;
      tagCounter = this._tagCounter.transaction(function (counter) {
        tagMap = _this2._tagMap.withMutations(function (map) {
          _untag(_this2._tagKeys, _this2._tagSuffix, counter, map, changed, object);
        });
      });
      if (changed.get()) {
        return new TaggerImmutable(this._tagKeys, this._tagSuffix, tagCounter, tagMap);
    ...
    value: function transaction(callback) {
      ...
      var tagCounter = void 0,
          tagMap = void 0;
      tagCounter = this._tagCounter.transaction(function (counter) {
        tagMap = _this3._tagMap.withMutations(function (map) {
          var taggerTransaction = {
            tag: function tag(object) {
              return _tag2(_this3._tagKeys, _this3._tagSuffix, counter, map, changed, object);
            },
            untag: function untag(object) {
              return _untag(_this3._tagKeys, _this3._tagSuffix, counter, map, changed, object);
            },
